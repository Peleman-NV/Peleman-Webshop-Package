...
use PWP\includes\handlers\Category_Handler;
use PWP\includes\handlers\Tag_Handler;
use WC_Product;
use PWP\includes\wrappers\Component;
use PWP\includes\wrappers\product\impl\Images;
use PWP\includes\wrappers\product\impl\Videos;
use PWP\includes\wrappers\product\impl\Attribute;
use WP_Term;
...
class Product extends Component
{
    ...
    public function default_attributes(): Component
    {
        return new Attribute($this->data->default_attributes);
    }

    public function attributes(): Component
    {
        return new Attribute($this->data->attributes);
    }

    public function images(): Component
    {
        return new Images($this->data->images);
    }

    public function upsell_SKUs(): Component
    {
    ...
    public function cross_sell_SKUs(): Component
    {
    ...
    public function videos(): Component
    {
        return new Videos($this->data->videos);
    }
