...
abstract class PWP_Create_Product_Command implements PWP_I_Command
{
    ...
    protected function set_product_imaxel_data(PWP_Product_Meta_Data $meta, array $data): void
    {
    ...
    protected function set_product_pdf_data(PWP_Product_Meta_Data $meta, array $data): void
    {
