...
class PWP_Admin_Notice
{
    ...
    {
        return new PWP_Admin_Notice("notice " . self::ERROR, $content, $dismissible);
    }

    public static function new_warning_notice(string $content, bool $dismissible = false): self
    {
        return new PWP_Admin_Notice("notice " . self::WARNING, $content, $dismissible);
    }

    public static function new_success_notice(string $content, bool $dismissible = false): self
    {
        return new PWP_Admin_Notice("notice " . self::SUCCESS, $content, $dismissible);
    }

    public static function new_info_notice(string $content, bool $dismissible = false): self
    {
        return new PWP_Admin_Notice("notice " . self::INFO, $content, $dismissible);
    }
