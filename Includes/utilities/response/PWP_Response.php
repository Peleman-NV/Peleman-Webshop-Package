...
class PWP_Response implements PWP_I_Response, PWP_I_Notice
{
    ...
    final public function add_response(PWP_I_Notice $response): void
    {
    ...
    final public function add_response_component(PWP_I_Notice $response): void
    {
        $this->components[] = $response;
    }
