...
<div class="product_meta">
    ...
    <?php if (($isSimpleProduct && !empty($individualPrice)) || !$isSimpleProduct) : ?>
        <span class="sku_wrapper">
            <span class="individual-price <?php _e(!$isBundleProduct ? 'pwp-hidden' : ''); ?>">
                <span class="label">
                    <?php _e('Individual price', PWP_TEXT_DOMAIN) . ': '; ?>
                </span>
                <span class="price-amount woocommerce-Price-amount amount">
                    <?php _e($isSimpleProduct && $isBundleProduct ? $individualPriceWithCurrencySymbol : ''); ?>
                </span>
            ...
            <span class="add-to-cart-price">
                <span class="label">
                    <?php _e('Bundle price', PWP_TEXT_DOMAIN) . ': '; ?>
                </span>
                <span class="price-amount woocommerce-Price-amount amount">
                    <?php _e($isSimpleProduct && $isBundleProduct ? $bundlePriceWithCurrencySymbol : $individualPriceWithCurrencySymbol); ?>
                </span>
                <span class="woocommerce-price-suffix">
                    <?php
                    _e($priceSuffix);
                    _e($isSimpleProduct && $isBundleProduct ? '<span class="bundle-suffix">' . $bundleLabel . '</span>' : '');
                    ?>
                </span>
            </span>
        </span>
